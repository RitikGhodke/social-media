...
//       {/* Search */}
//       <div ref={dropdownRef} className="w-[50%] flex flex-col relative">
//         <input
//           value={q}
//           onChange={(e) => setQ(e.target.value)}
//           type="text"
//           placeholder="Search..."
//           className="w-full px-4 py-2 rounded-full bg-gradient-to-r from-pink-50 to-blue-50 focus:outline-none focus:ring-4 focus:ring-pink-300 placeholder-gray-400 shadow-sm transition"
//         />
//         {suggestions.length > 0 && (
//           <div className="w-full absolute top-10 mt-3 bg-white shadow-lg rounded-xl border border-gray-200 max-h-60 overflow-y-auto z-50">
...
//         </p>
//         <div onClick={() => nav("/profile")} className="relative group">
//           <img
//             src={
//               userData.profilePicture ||
//               "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png"
