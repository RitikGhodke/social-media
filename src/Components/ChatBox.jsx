...
//                     <div className="sticky top-0 z-50 flex-shrink-0 flex items-center px-4 h-16 bg-white border-b border-gray-200 shadow-sm">
...
//                             className="flex-1 px-4 py-2 bg-gray-100 rounded-full focus:outline-none focus:ring-2 focus:ring-pink-300 text-sm [&::-webkit-search-cancel-button]:hidden [&::-webkit-search-decoration]:hidden"
//                         />
//                         <button
//                             onClick={btnClickHandler}
//                             disabled={!text.trim() && !imageBase64}
